...
export const APP_NAV_ITEMS: AppNavItem[] = [
  { to: '/', labelKey: 'nav.dashboard', icon: 'dashboard', group: 'primary', end: true },
  ...
  { to: '/reports', labelKey: 'nav.reports', icon: 'reports', group: 'primary', end: true },

  { to: '/daily', labelKey: 'nav.dailyNotes', icon: 'daily', group: 'secondary' },
  { to: '/weekly', labelKey: 'nav.weeklyNotes', icon: 'weekly', group: 'secondary' },
  { to: '/sync', labelKey: 'nav.sync', icon: 'sync', group: 'secondary', end: true },
  { to: '/profiles', labelKey: 'nav.profiles', icon: 'profiles', group: 'secondary', end: true, tourTarget: 'nav-profiles' },
  { to: '/preferences', labelKey: 'nav.preferences', icon: 'preferences', group: 'secondary', end: true },

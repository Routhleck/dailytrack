...
- Added branded dailytrack logo presentation on the homepage:
...
- Clarified onboarding WebDAV timing with explicit hint copy that realtime sync starts only after onboarding completes.
